    ...
    <div class="w-full min-h-screen flex items-center justify-center">
            <div class="lg:flex items-center space-x-16">
                <div class="w-5/6 md:w-3/4 lg:w-2/3 xl:w-[500px] 2xl:w-[550px] mt-8 mx-auto px-16 py-8 rounded-lg">
                    ...
                    <h2 class="text-center text-2xl font-bold tracking-wide text-gray-800">Registro</h2>
                    <p class="text-center text-sm text-gray-600 mt-2">Ya tienes una cuenta? <a href="index.php" class="text-blue-600 hover:text-blue-700 hover:underline" title="Sign In">Loguate aqui!</a></p>
                        ...
                        <?php
                            ...
                            if (isset($_SESSION['existe'])) {
                                if ($_SESSION['existe'] == True) {
                                    echo "No puedes usar ese email porque esta en uso!";
                    ...
                    <form class="my-8 text-sm" method="POST" action="register.php">
                        <div class="flex flex-col my-4">
                            <label for="name" class="text-gray-700">Nombre</label>
                            <input type="text" name="nombre" id="name" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 focus:border-indigo-600" placeholder="Ingresa tu nombre" required>
                        </div>
                        <div class="flex flex-col my-4">
                            <label for="name" class="text-gray-700">Apellido</label>
                            <input type="text" name="apellido" id="name" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 focus:border-indigo-600" placeholder="Ingresa tu apellido" required>
                        </div>

                        <div class="flex flex-col my-4">
                            <label for="email" class="text-gray-700">Email</label>
                            <input type="email" name="email" id="email" class="mt-2 p-2 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 focus:border-indigo-600" placeholder="Ingresa tu email" required>
                        </div>
                        ...
                        <div class="flex flex-col my-4">
                            ...
                            <div x-data="{ show: false }" class="relative flex items-center mt-2">
                                <input :type=" show ? 'text': 'password' " name="password" id="password" class="flex-1 p-2 border pr-10 border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 focus:border-indigo-600" placeholder="Ingresa tu contraseña" type="password" required>
                        ...
                        <div class="flex flex-col my-4">
                            ...
                            <div x-data="{ show: false }" class="relative flex items-center mt-2">
                                <input :type=" show ? 'text': 'password' " name="passwordConfirm" id="password_confirmation" class="flex-1 p-2 pr-10 border border-gray-300 focus:outline-none focus:ring-0 focus:border-gray-300 rounded text-sm text-gray-900 focus:border-indigo-600" placeholder="Ingresa tu contraseña denuevo" type="password" required>
                                <button @click="show = !show" type="button" class="absolute right-2 bg-transparent flex items-center justify-center text-gray-700">
                                    <svg x-show="!show" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21"></path></svg>
                        ...
                        <div class="flex flex-col my-4 border rounded-md border-gray-300">
                            <select name="genero" id="" class="indent-2 h-9" required>
                                <option value="Masculino" class="text-">Masculino</option>
                                <option value="Femenino" class="text-">Femenino</option>
                            </select>
                        </div>                    
                        <div class="my-4  text-center mx-auto  space-x-4">
                            <button class="bg-indigo-600 rounded-lg w-full px-8 py-2 text-gray-100 hover:shadow-xl transition duration-150 uppercase" type="submit">Registrar</button>
                        </div>
                    </form>
                </div>
