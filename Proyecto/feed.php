...
<div class="feeds w-1/3 mx-auto pt- relative">
    <div class="feed-wrapper">
        <div class="feed-item rounded ">
            <div class="header p-4 flex justify-between items-center">
                <div class="bg-white shadow-2xl rounded-3xl border-1 border-opacity-5">
                    <div class="flex flex-row px-2 py-3 mx-3">
                        ...
                        <div class="ml-auto">
                            ...
                            if ($_SESSION['idUsuario'] == $post['idUsuario']) {
                                include 'componentes/dropdown.php';
                            }
                            ?>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-start ">
                        <div class="flex justify-start w-full mt-1 pt-2 pl-5">
                            ...
                            ?>
                                <form action="likes/quitarLike.php" method="POST" class="h-7 w-7">
                            ...
                            ?>
                                <form action="likes/likePost.php" method="POST" class="h-7 w-7">
                                    <input type="hidden" name="idPost" value="<?php echo $post['idPost'] ?>">
                                    <?php
                    ...
                    <div class="relative block items-center self-center w-full max-w-xl p-4 overflow-hidden text-gray-600 ">
                        <div class="bottom border-t">
                            <div class="wrapper flex">
                                <form action="comentario.php" method="post" class="flex w-full">
                            ...
                            <div class="">
                                ...
                                $ccomentarios = mysqli_query($con,"select count(*) as total_comentarios from comentario where idPost=$post[idPost]");

                                if ($ccomentarios) {
                                    $fila = mysqli_fetch_array($ccomentarios);
                                ...
                                while ($comentario = mysqli_fetch_array($comentarios)) {
                                    if ($contadorComentarios < 2) {
                                        ...
                                        if ($_SESSION['idUsuario'] == $comentario['idUsuario']) {
                                            echo "<div class='text-red-500 float-right font-extrabold'><form action='eliminarComentario.php' method='POST'><input type='hidden' name='id' value='$comentario[idComentario]'><input type='submit' value='X' class='text-red-500 font-extrabold cursor-pointer '></form></div>";
                                            echo "</div>";
                                        } else {
                                            echo "</div>";
                                        } //
                                ...
                                ?>
                                        ...
                                        <div x-data="{ 'showModal': false }" @keydown.escape="showModal = false">
                                            <!-- Trigger for Modal -->
                                            <button type="button" @click="showModal = true"><?php echo "ver los " . $totalComentarios." comentarios" ?></button>
                                                        ...
                                                        <div class="bg-white overflow-hidden shadow-none">
                                                            <div class="grid grid-cols-3 min-w-full">
                                                                ...
                                                                <div class="col-span-2 w-full">
                                                                    ...
                                                                    if ($esImagen) {
                                                                        ?>
                                                                            <img class="max-w-2xl object-contain object-center" style="height:800px" src="post/<?php echo $post['imagen'] ?>">
                                                                        <?php
                                                                    }
