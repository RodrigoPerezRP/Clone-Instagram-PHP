            ...
            <div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:gap-6 xl:gap-8">
                ...
                ?>
                            ...
                            <a class="group relative flex h-48 items-end overflow-hidden rounded-lg bg-gray-100 shadow-lg md:h-80">
                                <video controls src="<?php echo "./post/" . $imagen['imagen'] ?>" loading="lazy" alt="Photo by Minh Pham" class="absolute inset-0 h-full w-full object-contain object-center"></video>
